...
namespace Bummerman
{
    ...
    class SystemManager
    {
        ...
        public void SetupSystems(Dictionary<string, Texture2D> textureCollection)
        {
            ...
            entitySystems.Add(new Systems.SpriteRenderSystem(textureCollection, entityManager.components));
            entitySystems.Add(new Systems.InputSystem(entityManager.components));
            entitySystems.Add(new Systems.BombSystem(entityManager.components));
            entitySystems.Add(new Systems.TileSystem(entityManager.components));
            entitySystems.Add(new Systems.MovementSystem(entityManager.components));
            entitySystems.Add(new Systems.CollisionSystem(entityManager.components));
