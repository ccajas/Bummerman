...
namespace Bummerman
{
    ...
    public abstract class ScreenElement
    {
        ...
        /// Container of children screen elements to be removed
        protected List<ScreenElement> toBeRemoved;
        ...
        public ScreenElement(ScreenElement previousScreenElement)
        {
            ...
            toBeRemoved = new List<ScreenElement>();
        }
        ...
        private ScreenElement UpdateState(TimeSpan frameStepTime)
        {
            ...
            if (screenStatus == ScreenStatus.TransitionOff)
            {
                ...
                if (!transition.Updating(frameStepTime, transition.offTime, 1))
                {
                    ...
                    UnloadContent();
                    screenStatus = ScreenStatus.Finished;
        ...
        public virtual ScreenElement Update(TimeSpan frameStepTime)
        {
            foreach (ScreenElement screen in children)
            {
                ...
                if (screen.ScreenStatus == ScreenStatus.Finished)
                    toBeRemoved.Add(screen);
            }

            // Remove any finished child screens
            foreach (ScreenElement screen in toBeRemoved)
